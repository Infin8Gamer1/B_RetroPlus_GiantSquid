...
GhostBehaviorRed::GhostBehaviorRed() : GhostBehavior()
{
}

Component * GhostBehaviorRed::Clone() const
{
	return new GhostBehaviorRed(*this);
}

void GhostBehaviorRed::Initialize()
{
...
Vector2D GhostBehaviorRed::GenerateTarget()
{
